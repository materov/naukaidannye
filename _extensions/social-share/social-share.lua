...
function Meta(m)
  ...
  if m.share.telegram then
    share_text = share_text ..
        '<a href="https://t.me/share/url?url=' ..
        share_url ..
        '&title=' ..
        post_title .. '" target="_blank" class="telegram"><i class="fa-brands fa-telegram fa-fw fa-lg"></i></a>'
  end
  ...
  if m.share.mastodon then
    share_text = share_text ..
        '<a href="javascript:void(0);" onclick="var mastodon_instance=prompt(\'Введите название сервера Mastodon\'); if(typeof mastodon_instance===\'string\' &amp;&amp; mastodon_instance.length){this.href=\'https://\'+mastodon_instance+\'/share?text=' ..
        post_title ..
        ' ' ..
        share_url ..
